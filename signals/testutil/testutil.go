...
// MockMetrics returns a mock []signals.Metric object for using in unit tests
// of output sinks.
func MockMetrics() []signals.Metric {
	metrics := make([]signals.Metric, 0)
...
func TestMetric(value interface{}, name ...string) signals.Metric {
	if value == nil {
