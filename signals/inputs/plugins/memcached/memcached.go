...
func (m *Memcached) GatherUnmanagedAsync(shutdown chan struct{}) error {
	return nil
}
...
func (m *Memcached) gatherServer(
	...
	// asit: We don't need server also server=:11211 conflicts
	// on opentsdb telnet put
	// tags := map[string]string{"server": address}
	tags := map[string]string{"server": "localhost"}
