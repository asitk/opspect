...
var defaultServer = "Server=.;app name=infrared;log=1;"
...
var sampleConfig = `
  ...
  ##   parameters.
  # servers = [
  #  "Server=192.168.1.10;Port=1433;User Id=<user>;Password=<pw>;app name=infrared;log=1;",
  # ]
`
...
func (s *SQLServer) GatherUnmanagedAsync(shutdown chan struct{}) error {
	return nil
}
