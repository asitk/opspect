...
USE master; 
GO
CREATE LOGIN [infrared] WITH PASSWORD = N'mystrongpassword';
GO
GRANT VIEW SERVER STATE TO [infrared]; 
GO
GRANT VIEW ANY DEFINITION TO [infrared]; 
GO
```
...
[[inputs.sqlserver]]
  ...
  servers = [
	"Server=192.168.1.30;Port=1433;User Id=infrared;Password=T$l$gr@f69*;app name=infrared;log=1;",
    "Server=192.168.1.30;Port=2222;User Id=infrared;Password=T$l$gr@f69*;app name=infrared;log=1;"
	]
```
