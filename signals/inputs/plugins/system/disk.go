...
var diskSampleConfig = `
  # By default, gather stats for all mountpoints.
...
func (_ *DiskStats) GatherUnmanagedAsync(shutdown chan struct{}) error {
	return nil
}
...
func (s *DiskIOStats) GatherUnmanagedAsync(shutdown chan struct{}) error {
	return nil
}
