...
type Plugin interface {
	...
	// GatherUnmanagedAsync is used by unmanaged plugins to gather data
	// and record output directly at its own interval. It needs to be
	// asynchronous
	GatherUnmanagedAsync(chan struct{}) error
}
