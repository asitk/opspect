...
public class QRMetric {
  ...
  public QRMetric() {};
  public QRMetric(String name, long limit, ArrayList<QRTag> tags, ArrayList<QRAggregator> aggregators) {
    this.name = name;
    this.limit = limit;
    this.tags = tags;
  ...
  public String toString() {
    return "QRMetric{" + "name=" + name + ", limit=" + limit + ", tags=" + tags + ", aggregators=" + aggregators + '}';
  }
}
