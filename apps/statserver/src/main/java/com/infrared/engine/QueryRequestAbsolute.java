...
public class QueryRequestAbsolute {
  ...
  public QueryRequestAbsolute(long start_absolute, long end_absolute, long cache_time, String time_zone, ArrayList<QRMetric> metrics) {
  ...
  public String toString() {
    return "QueryRequestAbsolute{" + "start_absolute=" + start_absolute + ", end_absolute=" + end_absolute + ", cache_time=" + cache_time + ", time_zone=" + time_zone + ", metrics=" + metrics + '}';
  }
}
