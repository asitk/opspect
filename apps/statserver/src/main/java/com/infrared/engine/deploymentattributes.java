...
public class deploymentattributes {
    ...
    public deploymentattributes(String method, String deployment_id, String customer_id, long sts, long ets,
                                ArrayList<deploymentstats> stats, com.infrared.engine.thermal thermal,
