...
public class service {
    ...
    public String getdeploymentmarkers(String s) {
        ...
        try 
        {
          ...
          // {"deployment_id":"ec2-dc-01", "customer_id":"1234abcd", "sts":"1463052810", "ets":"1463052810"}
    ...
    public String getclustersnapshot(String s) {
      ...
      try {
          ...
          "                {\n" +
          "                    \"req\": \"GET / HTTP/1.1Host: 192.168.6.21Connection: keep-alivePragma: no-cacheCache-Control: no-cacheAccept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8Upgrade-Insecure-Requests: 1User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2623.112 Safari/537.36Accept-Encoding: gzip, deflate, sdchAccept-Language: en-US,en;q=0.8\",\n" +
          "                    \"count\": 1,\n" +
          "                    \"ttfb\": 1188,\n" +
          "                    \"ttlb\": 1188\n" +
          "                },\n" +
          "                {\n" +
          "                    \"req\": \"GET /icons/ubuntu-logo.png HTTP/1.1Host: 192.168.6.21Connection: keep-alivePragma: no-cacheCache-Control: no-cacheAccept: image/webp,image/*,*/*;q=0.8User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2623.112 Safari/537.36Referer: http://192.168.6.21/Accept-Encoding: gzip, deflate, sdchAccept-Language: en-US,en;q=0.8\",\n" +
          "                    \"count\": 2,\n" +
          "                    \"ttfb\": 23,\n" +
          "                    \"ttlb\": 24\n" +
          "                }\n" +
