...
public class AggregatorFactory {
  ...
  /**
   * Creates an aggregator that returns the minimum values for each time period as specified. For
   * example, "5 minutes" would returns the minimum value for each 5 minute period.
   *
  ...
  /**
   * Creates an aggregator that returns the maximum values for each time period as specified. For
   * example, "5 minutes" would returns the maximum value for each 5 minute period.
   *
   * @param value value for time period.
   * @param unit unit of time
  ...
  /**
   * Creates an aggregator that returns the average values for each time period as specified. For
   * example, "5 minutes" would returns the average value for each 5 minute period.
   *
   * @param value value for time period.
   * @param unit unit of time
  ...
  /**
   * Creates an aggregator that returns the standard deviation values for each time period as
   * specified. For example, "5 minutes" would returns the standard deviation for each 5 minute
   * period.
   *
   * @param value value for time period.
   * @param unit unit of time
  ...
  /**
   * Creates an aggregator that returns the percentile value for a given percentage of all values
   * over each time period as specified. For example, "0.5" and "5 minutes" would returns the median
   * of data points for each 5 minute period.
   *
   * @param value percentage
   * @param unit unit of time
   * @return percentile aggregator
   */
  public static PercentileAggregator createPercentileAggregator(
      double percentile, int value, TimeUnit unit) {
  ...
  /**
   * Creates an aggregator that marks gaps in data according to sampling rate with a null data
   * point.
   *
   * @param value value for time period.
   * @param unit unit of time
  ...
  /**
   * Creates an aggregator that returns a best fit line through the datapoints using the least
   * squares algorithm..
   *
   * @param value value for time period.
   * @param unit unit of time
  ...
  /**
   * Creates an aggregator with a custom json fragment. This method is used for custom aggregators
   * that have been added to KairosDB. This does not create an aggregator on the server. The name
   * must match the custom aggregator on the server.
   *
   * <p>Example:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>This produces aggregator JSON that looks like this:
   *
   * <pre>
   *      "name":"scale",
   *      "factor": 0.75
