...
public interface Client {
  ...
  /**
   * Registers a new custom data type. The assumption is that this data type already exists on the
   * server. The dataPointValueClass is used to serialize and deserialize the custom type. This is
   * simply a POJO.
   *
  ...
  /**
   * Returns the data point value class for the given group type or null if one is not registered
   * for the group type
   *
