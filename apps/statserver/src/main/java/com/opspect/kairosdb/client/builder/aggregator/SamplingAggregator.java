...
public class SamplingAggregator extends Aggregator {
   ...
   * seconds, minutes or hours then the start of the range will always be at the top of the hour.
   * The effect of setting this to true is that your data will take the same shape when graphed as
   * you refresh the data.
   *
   * <p>
   *
   * <p>Only one alignment type can be used.
   */
  ...
  /**
   * Alignment based on the aggregation range rather than the value of the first data point within
   * that range.
   *
   * <p>
   *
  ...
  /**
   * Alignment that starts based on the specified time. For example, if startTime is set to noon
   * today,then alignment starts at noon today.
   *
   * <p>
   *
   * <p>Only one alignment type can be used.
  ...
  public boolean equals(Object o) {
    ...
    if (alignStartTime != null
        ? !alignStartTime.equals(that.alignStartTime)
        : that.alignStartTime != null) return false;
    if (alignSampling != null
        ? !alignSampling.equals(that.alignSampling)
        : that.alignSampling != null) return false;
