...
public class RelativeTime {
  ...
  /**
   * Returns the time in milliseconds relative to the specified time. For example, if this object is
   * set to 3 days, this method returns 3 days from <code>time</code>.
   *
