...
public class RestDemoServiceIT {
  ...
  @Test
  public void testGetPodcasts() throws JsonGenerationException, JsonMappingException, IOException {
    ...
    WebTarget webTarget = client.target("http://localhost:7779/demo-rest-jersey-spring/podcasts/");
    ...
    Assert.assertTrue("At least one podcast is present", podcasts.size() > 0);
  }
  ...
  public void testGetPodcast() throws JsonGenerationException, JsonMappingException, IOException {
    ...
    WebTarget webTarget = client.target("http://localhost:7779/demo-rest-jersey-spring/podcasts/2");
  ...
  public void testGetLegacyPodcasts()
    ...
    WebTarget webTarget =
        client.target("http://localhost:7779/demo-rest-jersey-spring/legacy/podcasts/");
  ...
  @Test
  public void testGetLegacyPodcast()
      throws JsonGenerationException, JsonMappingException, IOException {
    ...
    WebTarget webTarget =
        client.target("http://localhost:7779/demo-rest-jersey-spring/legacy/podcasts/2");
    ...
    ObjectMapper mapper = new ObjectMapper();
    System.out.print(
        "Received podcast from LEGACY database *************************** "
            + mapper.writerWithDefaultPrettyPrinter().writeValueAsString(podcast));
  }
}
