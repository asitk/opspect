    ...
    return {
      ...
      module: {
        loaders: [
          ...
          //{ test: /\.png$/, loader: 'url?limit=10000&name=[path][name].[ext]' }, asit
          //{ test: /\.(jpe?g|png|gif|svg)$/i, loaders: [ 'url?limit=10000&name=[path][name].[ext]', 'img?-minimize' ] },
          { test: /\.(jpe?g|png|gif)$/i, loaders: [ 'url?limit=10000&name=[path][name].[ext]', 'img?minimize' ] },
