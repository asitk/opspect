...
import 'ui/visualize';
import 'ui/doc_table';
import PluginsKibanaDashboardComponentsPanelLibLoadPanelProvider from 'plugins/infrared/dashboard/components/panel/lib/load_panel';
import FilterManagerProvider from 'ui/filter_manager';
import UtilsBrushEventProvider from 'ui/utils/brush_event';
import uiModules from 'ui/modules';
import panelTemplate from 'plugins/infrared/dashboard/components/panel/panel.html';
...
.directive('dashboardPanel', function (savedVisualizations, savedSearches, Notifier, Private, $injector) {
  ...
  const services = require('plugins/infrared/settings/saved_object_registry').all().map(function (serviceObj) {
