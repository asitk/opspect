...
import 'ui/share';
import 'plugins/infrared/dashboard/directives/grid';
import 'plugins/infrared/dashboard/components/panel/panel';
import 'plugins/infrared/dashboard/services/saved_dashboards';
import 'plugins/infrared/dashboard/styles/main.less';
import FilterBarQueryFilterProvider from 'ui/filter_bar/query_filter';
import DocTitleProvider from 'ui/doc_title';
import uiRoutes from 'ui/routes';
import uiModules from 'ui/modules';
import indexTemplate from 'plugins/infrared/dashboard/index.html';



require('ui/saved_objects/saved_object_registry').register(require('plugins/infrared/dashboard/services/saved_dashboard_register'));
  ...
  return {
    controller: function ($scope, $rootScope, $route, $routeParams, $location, Private, getAppState) {
      ...
      $scope.topNavMenu = [{
        ...
        template: require('plugins/infrared/dashboard/partials/pick_visualization.html')
      }, {
        key: 'save',
        description: 'Save Dashboard',
        template: require('plugins/infrared/dashboard/partials/save_dashboard.html')
      }, {
        key: 'open',
        description: 'Load Saved Dashboard',
        template: require('plugins/infrared/dashboard/partials/load_dashboard.html')
      }, {
        key: 'share',
        description: 'Share Dashboard',
        template: require('plugins/infrared/dashboard/partials/share.html')
      }, {
        key: 'options',
        description: 'Options',
        template: require('plugins/infrared/dashboard/partials/options.html')
      }];
