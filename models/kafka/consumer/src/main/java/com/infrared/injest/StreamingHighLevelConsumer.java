...
class StreamingHighLevelConsumerThread implements Runnable, Serializable {
    ...
    public StreamingHighLevelConsumerThread(KafkaStream a_stream, int a_threadNumber, Receiver<String> receiver) {
...
public class StreamingHighLevelConsumer extends Receiver<String> {
    ...
    private void Execute(int a_numThreads) {
        ...
        for (final KafkaStream stream : streams) {
            ...
            //_consumerThread = new Thread(new StreamingHighLevelConsumerThread(stream, threadNumber, m_reciever));
            _consumerThread = new Thread(new StreamingHighLevelConsumerThread(stream, threadNumber, this));
